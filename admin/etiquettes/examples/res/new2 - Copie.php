                    ...
                    <table class="tg">
                        ...
                        <tr>
                            <td class="tg-cly1" style="height:45px;width:70%;font-size: 10px;padding-left: 3px; margin :0px " colspan="5">
                                <?php 
                                    if(strlen($listingExemplaires[$j]['descriptionJeu'])>200)
                                    {
                                        echo substr($listingExemplaires[$j]['descriptionJeu'],0, 200)." [...]";
                                    }
                                    else
                                    {
                        ...
                        <tr>
                            <td class="tg-cly1" style="width:16%;padding: 0px; margin :0px; text-align:center"><img src="/var/www/remyperret.org/cabaneajeux/img/picto1.png"></td>
                            <td class="tg-cly1" style="width:16%;padding: 0px; margin :0px; text-align:center"><img src="/var/www/remyperret.org/cabaneajeux/img/picto2.png"></td>
                            <td class="tg-cly1" style="width:16%;padding: 0px; margin :0px; text-align:center"><img src="/var/www/remyperret.org/cabaneajeux/img/picto3.png"></td>
                             <td class="tg-cly1" style="width:16%;padding: 0px; margin :0px; text-align:center" rowspan="2"><img src="/var/www/remyperret.org/cabaneajeux/img/litteratie<?php echo $listingExemplaires[$j]['litteratieJeu'];?>.png"></td>
                            <td class="tg-cly1" style="width:16%;padding: 0px; margin :0px; text-align:center" rowspan="2"><img src="/var/www/remyperret.org/cabaneajeux/img/<?php echo getTypePicto($listingExemplaires[$j]['typeJeu']);?>.png"></td>
                        </tr>
                        <tr>
