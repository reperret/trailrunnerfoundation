...
$courses=getCourses(NULL,$keyWord,$dateDebut,$dateFin,$typeCourse,$dbh); //getCourses($idCourse,$keyWord,$dateDebut,$dateFin,$typeCourse,$dbh)
$gps=array();
                                    ...
                                    <div class="search_map_wp" style="display: block;">
                                        <div class="custom-search-input-2 map_view">
                                            <div class="form-group">
                                                <input class="form-control" type="text" name="keyWord" placeholder="Nom, département, ville, mots clefs... " value="<?php if(isset ($_POST['keyWord']) && $_POST['keyWord']!='') echo $_POST['keyWord'];?>">
