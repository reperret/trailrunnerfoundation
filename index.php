                                    ...
                                    <div class="search_map_wp" style="display: block;">
                                        <div class="custom-search-input-2 map_view">
                                            <div class="form-group">
                                                <input class="form-control" type="text" name="keyWord" placeholder="Nom, ville, mots clefs... " value="<?php if(isset ($_POST['keyWord']) && $_POST['keyWord']!='') echo $_POST['keyWord'];?>">
                                                <i class="icon_search"></i>
                                            </div>
                                            
                                             <div class="form-group">
                                                <input class="form-control" type="text" name="dates" placeholder="Dates" value="<?php if(isset ($_POST['dates']) && $_POST['dates']!='') echo $_POST['dates'];?>" autocomplete="off">
                                                <i class="icon_calendar"></i>
                                            </div>
                                            
                                        
                                            <select class="wide" name="departement">
                                                <option value="-1" <?php if($_POST['departement']=="-1") echo "selected";?>>Tous les départements</option>
                                                <?php
                                                ...
                                                {
                                                ?>
                                                <option value="<?php echo $numDepartement;?>" <?php if($_POST['departement']==$numDepartement) echo "selected";?>><?php echo $numDepartement." - ".$libelleDepartement;?></option>
                                                 <?php
                                                }
                                                ?>
                                            </select>
                                            ...
                                            <select class="wide" name="typeCourse">
                                                <option value="-1" <?php if($_POST['typeCourse']=="-1") echo "selected";?>>Toutes les courses</option>
                                                <option value="0" <?php if($_POST['typeCourse']=="0") echo "selected";?>>Courses adhérentes</option>
                                                <option value="1" <?php if($_POST['typeCourse']=="1") echo "selected";?>>Courses labelisées</option>
                                            </select>
                            ...
                            <div class="row g-0 add_top_20">
                                <div class="col-4">
                                    <figure>
                                        ...
                                        <a href="detailscourse.php?idC=<?php echo $course['idCourse'] ;?>"><img src="admin/images/<?php echo $vignette ;?>" class="img-fluid" alt="" width="800" height="533"></a>
                                    </figure>
                                </div>
                                <div class="col-8">
                                    <div class="wrapper">
                                        <!-- <a href="#0" class="wish_bt"></a>-->
                                        <h3><a href="detailscourse.php?idC=<?php echo $course['idCourse'] ;?>"><?php echo $course['libelleCourse'] ;?></a></h3>
                                        <span class="price">
                                            <strong>
                                                <?php 
                                        ...
                                        <p><?php echo $course['villeCourse'] ;?>
                                            <?php if($course['codepostalCourse']!='') echo "(".$course['codepostalCourse'].")" ;?></p>
                                    </div>
                                    <ul>
                                        <li>
                                            <a href="#0" data-id="<?php echo $course['idCourse'] ;?>" class="address">Voir sur la carte</a>
                                        </li>
                                        <li>
                                            <div class="score">
                                                <span><a href="<?php echo $course['sitewebCourse'] ;?>" target="_blank">Site web</a>
                                                    <em>
    ...
    <script>
        ...
        for (var i = 0; i < markers.length; ++i) {
            ...
            var popup =
                ...
                '<form action="https://maps.google.com/maps" method="get" target="_blank"><input name="saddr" value="' + markers[i].get_directions_start_address + '" type="hidden"><input type="hidden" name="daddr" value="' + markers[i].location_latitude + ',' + markers[i].location_longitude + '"><button type="submit" value="Itinéraire" class="btn_infobox_get_directions">Itinéraire</button></form>' +
                '</span>';
